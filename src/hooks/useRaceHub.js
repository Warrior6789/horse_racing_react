...
export function useRaceHub(raceId, { onPoolUpdate, onRaceUpdate, onRacesUpdated, onPaymentsUpdated, onWithdrawalsUpdated, onUpgradeRequestsUpdated, onRegistrationsUpdated, onBalanceUpdated } = {}) {
