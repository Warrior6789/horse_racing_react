      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="bg-gray-900 p-5 rounded-2xl flex items-center justify-between">
            <div>
              <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1">Total Takeout Collected</p>
              <p className="text-3xl font-extrabold text-white">{totalTakeout.toLocaleString('en-US')}</p>
              <p className="text-xs text-gray-400 mt-0.5">All matching records · VND</p>
            </div>
